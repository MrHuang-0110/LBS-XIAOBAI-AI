...
(function (root, factory) {
    ...
    CUSTOM_CONTEXT_MENU_VARIABLE_GETTER_SETTER_MIXIN$$module$build$src$blocks$variables_dynamic =
      {
        customContextMenu: function (a) {
          if (!this.isInFlyout) {
            ...
            b = { type: b, fields: { VAR: d.saveState(!0) } };
            a.push({
        ...
        if (!this.isInFlyout) {
          ...
          if (!this.isCollapsed())
            for (b = 0; b < this.argumentVarModels_.length; b++) {
              ...
              const d = {
                type: "variables_get",
                fields: { VAR: { name: c.name, id: c.getId(), type: c.type } },
              };
              a.push({
                enabled: !0,
    ...
    PROCEDURE_CALL_COMMON$$module$build$src$blocks$procedures = {
      ...
      onchange: function (a) {
        if (this.workspace && !this.workspace.isFlyout && a.recordUndo)
          if (
            a.type === $.BLOCK_CREATE$$module$build$src$core$events$events &&
            a.ids.includes(this.id)
          ) {
            var b = this.getProcedureCall(),
              c = $.getDefinition$$module$build$src$core$procedures(
                b,
                this.workspace,
              );
            !c ||
              (c.type === this.defType_ &&
                JSON.stringify(c.getVars()) ===
            ...
            if (c)
              c.isEnabled() ||
                (this.setDisabledReason(
                  !0,
                  DISABLED_PROCEDURE_DEFINITION_DISABLED_REASON$$module$build$src$blocks$procedures,
                ),
                this.setWarningText(
                  $.Msg$$module$build$src$core$msg.PROCEDURES_CALL_DISABLED_DEF_WARNING.replace(
                    "%1",
                    b,
                  ),
                ));
              ...
              var d =
                c.y + 2 * $.config$$module$build$src$core$config.snapRadius;
              b.setAttribute(
                "x",
                `${c.x + $.config$$module$build$src$core$config.snapRadius * (this.RTL ? -1 : 1)}`,
              );
              b.setAttribute("y", `${d}`);
              ...
              c.appendChild(
                $.createTextNode$$module$build$src$core$utils$xml(d),
              );
              b.appendChild(c);
              a.appendChild(b);
            ...
            a.type === $.BLOCK_DELETE$$module$build$src$core$events$events
              ? ((b = this.getProcedureCall()),
                $.getDefinition$$module$build$src$core$procedures(
                  ...
                  $.setGroup$$module$build$src$core$events$utils(!1)))
              : a.type ===
                  $.BLOCK_CHANGE$$module$build$src$core$events$events &&
                "disabled" === a.element &&
                ((b = this.getProcedureCall()),
                (d = $.getDefinition$$module$build$src$core$procedures(
                  b,
                  this.workspace,
                )) &&
                  d.id === a.blockId &&
        ...
        if (this.workspace.isMovable()) {
          ...
          a.push({
            ...
            callback: function () {
              ...
              d &&
                (c.centerOnBlock(d.id),
                $.setSelected$$module$build$src$core$common(d));
            },
          });
        }
      },
  ...
  var UNPARENTED_IFRETURN_DISABLED_REASON$$module$build$src$blocks$procedures =
      "UNPARENTED_IFRETURN",
      ...
      onchange: function (a) {
        if (
          !(
            ...
            (a.type !== $.BLOCK_MOVE$$module$build$src$core$events$events &&
              a.type !== $.BLOCK_CREATE$$module$build$src$core$events$events)
          )
        ) {
          a = !1;
          ...
          if (!this.isInFlyout)
            try {
              $.setRecordUndo$$module$build$src$core$events$utils(!1),
                this.setDisabledReason(
                  !a,
                  UNPARENTED_IFRETURN_DISABLED_REASON$$module$build$src$blocks$procedures,
                );
            } finally {
  ...
  var CUSTOM_CONTEXT_MENU_CREATE_VARIABLES_GET_MIXIN$$module$build$src$blocks$loops =
    {
      customContextMenu: function (a) {
        if (!this.isInFlyout) {
          ...
          this.isCollapsed() ||
            null === c ||
            ((b = { type: "variables_get", fields: { VAR: b.saveState(!0) } }),
            a.push({
              enabled: !0,
              text: $.Msg$$module$build$src$core$msg.VARIABLES_SET_CREATE_GET.replace(
                "%1",
  ...
  var loopTypes$$module$build$src$blocks$loops = new Set([
    ...
    CONTROL_FLOW_NOT_IN_LOOP_DISABLED_REASON$$module$build$src$blocks$loops =
      "CONTROL_FLOW_NOT_IN_LOOP",
  ...
  var LISTS_GETINDEX$$module$build$src$blocks$lists = {
    init: function () {
      ...
      a.setValidator(function (b) {
        ...
        b !== ("FROM_START" === c || "FROM_END" === c) &&
          this.getSourceBlock().updateAt_(b);
      });
