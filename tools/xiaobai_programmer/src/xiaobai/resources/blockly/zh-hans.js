...
(function (root, factory) {
  ...
  Blockly.Msg["CONTROLS_FOR_TOOLTIP"] =
    "让变量“%1”记录开始数到结束数之间指定间隔的值，并执行指定的块。";
  ...
  Blockly.Msg["CONTROLS_REPEAT_HELPURL"] =
    "https://zh.wikipedia.org/wiki/For循环";
  ...
  Blockly.Msg["LISTS_INDEX_OF_HELPURL"] =
    "https://github.com/google/blockly/wiki/Lists#finding-items-in-a-list"; // untranslated
  ...
  Blockly.Msg["LOGIC_NEGATE_TOOLTIP"] =
    "如果输入结果为false，则返回true；如果输入结果为true，则返回false。";
  ...
  Blockly.Msg["LOGIC_TERNARY_HELPURL"] =
    "https://zh.wikipedia.org/wiki/条件运算符%3F:";
  ...
  Blockly.Msg["MATH_CONSTANT_HELPURL"] =
    "https://zh.wikipedia.org/wiki/数学常数";
  ...
  Blockly.Msg["PROCEDURES_CALL_DISABLED_DEF_WARNING"] =
    "Can't run the user-defined function '%1' because the definition block is disabled."; // untranslated
